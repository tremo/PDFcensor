  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="prose prose-sm dark:prose-invert max-w-none space-y-6">
        ...
        <p>
          By using OfflineRedact, you agree to these Terms of Service. If you do not
          agree, do not use the service.
        </p>

        <h2 className="text-xl font-semibold mt-8">2. Service Description</h2>
        <p>
          OfflineRedact is a client-side PDF redaction tool that detects and removes
        ...
        <p>
          While we strive for accuracy, OfflineRedact does not guarantee 100% detection
        ...
        <p>For questions about these terms, contact us at legal@offlineredact.com.</p>
      </div>
    </div>
  );
}
